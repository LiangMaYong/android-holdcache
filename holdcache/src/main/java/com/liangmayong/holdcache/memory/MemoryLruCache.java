...
package com.liangmayong.holdcache.memory;
 ...
 *   MemoryLruCache<String, Bitmap> bitmapCache = new MemoryLruCache<String, Bitmap>(cacheSize) {
 ...
 * <a href="http://developer.android.com/sdk/compatibility-library.html">Android
 * 's Support Package</a> for earlier releases.
 */
class MemoryLruCache<K, V> {
	...
	public synchronized final String toString() {
		...
		return String.format("MemoryLruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", maxSize, hitCount, missCount,
				hitPercent);
	}
}
