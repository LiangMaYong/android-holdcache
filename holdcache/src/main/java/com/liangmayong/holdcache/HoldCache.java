package com.liangmayong.holdcache;

import android.content.Context;
import android.graphics.Bitmap;
import android.graphics.drawable.Drawable;

import com.liangmayong.holdcache.disk.DiskManager;
import com.liangmayong.holdcache.interfaces.ICacheInterface;
import com.liangmayong.holdcache.memory.MemoryManager;
 ...
 * @version 1.0
 */
public class HoldCache implements ICacheInterface {

    private static Context mContext;

    private static DiskManager mDdiskCacheManager;
    private static volatile HoldCache INSTANCE = null;

    public static HoldCache getInstance(Context context) {
        if (INSTANCE == null) {
            synchronized (HoldCache.class) {
                if (INSTANCE == null) {
                    INSTANCE = new HoldCache();
                }
            }
